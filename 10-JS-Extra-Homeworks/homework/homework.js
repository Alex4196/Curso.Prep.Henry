...
let palta = Object.entries(objeto);
return palta;
}
...
var palta = {} ;
for ( var i in string){
  palta[string[i]] = (palta[string[i]] || 0 ) + 1; //incrementamos el valor si el elemento ya existe
}
return palta;
}
...
var palabra = cap.join("").concat(nocap.join(""));
return palabra;
}
